...
If you want to do all your work in the RMarkdown document, have your code be evaluated but supress the output of models, plots etc. you can use:

1. <span style="color: #5196b4;background-color:#f4e4e7">`results = "hide"`</span>: Supress printing results to document.
1. <span style="color: #5196b4;background-color:#f4e4e7">`fig.keep = "none"`</span>: Supress printing of plots to document.
